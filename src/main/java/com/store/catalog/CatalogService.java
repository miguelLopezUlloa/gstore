...
import com.store.GenericStoreException;
...
public class CatalogService {
	...
	public Category createCategory(Category category) {
		...
		if (persistedCategory != null) {
			throw new GenericStoreException("Category " + category.getName() + " already exist");
		}
	...
	public Category updateCategory(Category category) {
		...
		if (persistedCategory == null) {
			throw new GenericStoreException("Category " + category.getId() + " doesn't exist");
		}
	...
	public Product createProduct(Product product) {
		...
		if (persistedProduct != null) {
			throw new GenericStoreException("Product SKU " + product.getSku() + " already exist");
		}
	...
	public Product updateProduct(Product product) {
		...
		if (persistedProduct == null) {
			throw new GenericStoreException("Product " + product.getId() + " doesn't exist");
		}
