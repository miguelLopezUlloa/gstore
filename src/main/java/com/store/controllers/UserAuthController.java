...
import static com.store.admin.web.utils.MessageCodes.*;
...
import com.store.common.services.EmailService;
import com.store.security.SecurityService;

@Controller
public class UserAuthController extends GenericStoreAdminBaseController
{
