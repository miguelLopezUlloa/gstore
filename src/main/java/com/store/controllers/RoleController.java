...
import com.store.admin.web.validators.RoleValidator;
...
public class RoleController extends GenericStoreAdminBaseController
{
	...
	public String listRoles(Model model) {
		...
		List<RoleEntity> list = securityService.getAllRoles();
	...
	public String createRole(@Valid @ModelAttribute("role") RoleEntity role, BindingResult result, 
		...
		RoleEntity persistedRole = securityService.createRole(role);
	...
	public String editRoleForm(@PathVariable Integer id, Model model) {
		...
		RoleEntity role = securityService.getRoleById(id);
	...
	public String updateRole(@ModelAttribute("role") RoleEntity role, BindingResult result, 
			Model model, RedirectAttributes redirectAttributes) {	
		
		RoleEntity persistedRole = securityService.updateRole(role);
